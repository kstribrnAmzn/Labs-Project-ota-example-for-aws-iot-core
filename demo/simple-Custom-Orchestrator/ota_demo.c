                             ...
                             size_t messageLength )
{
    ...
    {
        CustomJobDocumentFields_t jobFields = { 0 };
        ...
        do
        {
             ...
             */
            fileIndex = customParser_parseJobDocFile( jobDoc,
                                                      jobDocLength,
                                                      &jobFields );

            if( fileIndex >= 0 )
            {
                printf( "Received Custom Job Document \n" );
                /* Process the job file here */
                printf( "Successfully processed job document.\n" );
            }
        } while( fileIndex > 0 );
    }
